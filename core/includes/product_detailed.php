                ...
                else
                {
                        ...
                        if ($a) //product found
                        {
                                ...
                                if ($cnt[0] > 0)
                                {
                                        ...
                                        {
$p = db_query("SELECT ".PRODUCTS_TABLE.".productID, ".PRODUCTS_TABLE.".name, ".PRODUCTS_TABLE.".Price , ".PRODUCT_PICTURES.".filename FROM ".PRODUCTS_TABLE."  
LEFT JOIN ".PRODUCT_PICTURES." ON ".PRODUCTS_TABLE.".default_picture = ".PRODUCT_PICTURES.".photoID WHERE ".PRODUCTS_TABLE.".productID=".$row[0]."  and ".PRODUCTS_TABLE.".enabled=1;") or die (db_error());
								...
								if (!empty($a["list_price"]) && $a["Price"]) {
								if ($a["list_price"] >$a["Price"] )
									$a['skidka'] = show_price( $a["list_price"] - $a["Price"]); //you save (value)
